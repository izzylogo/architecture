...
setInterval(landingSwitch, 80000)
...
//         backgrounds[index].classList.add('active')
//     }
//     console.log(e.target,"Clicking!!!")

// }

const layoutDivs = document.querySelectorAll('.layout-2 div')
const bgDivs = document.querySelectorAll('.bg div')

layoutDivs.forEach((div, index) => {
  div.addEventListener('click', function () {
    // Remove the 'active' class from all bgDivs
    bgDivs.forEach((bgDiv) => {
      bgDiv.classList.remove('active')
    })

    // Add the 'active' class to the corresponding bgDiv
    bgDivs[index].classList.add('active')
  })
